...
class AddQtySgkBookWizard(models.TransientModel):
    _name = 'add.qty.sgk.book.wizard'
    _description = 'Nhập bổ sung số lượng'

    line_id = fields.Many2one('stock.check.sgk.book.line', string="Dòng kiểm tồn", required=True)
